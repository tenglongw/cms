...
require_once(QQ_CLASS_PATH."API/class/Recorder.class.php");
require_once(QQ_CLASS_PATH."API/class/URL.class.php");
require_once(QQ_CLASS_PATH."API/class/ErrorCase.class.php");
