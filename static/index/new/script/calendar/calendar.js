       // 2017-01-10 10:56:15 日历
        ...
        $(function() {
           ...
           function ajaxFun(Year,Month){
            $.ajax({
                url: 'http://139.224.56.54/l7cms/index.php/index/comment/issueList?date='+Year+'-'+Month,
                type: 'POST',
                dataType: 'JSONP',
            })
            .done(function(data) {
        ...
        function Forzi(data){
            ...
            for (var i = 0; i < data.length; i++) {
                html += '<li>'+
                            '<a href="http://139.224.56.54/'+data[i].url+'">'+
                                '<div class="imgC"><img src="http://139.224.56.54/'+data[i].thumb+'"></div>'+
