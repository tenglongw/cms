<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:62:"E:\workspace-php\l7cms\templates\default\content\newsInfo.html";i:1490929783;s:57:"E:\workspace-php\l7cms\templates\default\common\head.html";i:1488795468;s:59:"E:\workspace-php\l7cms\templates\default\common\header.html";i:1489038618;s:68:"E:\workspace-php\l7cms\templates\default\content\detail_comment.html";i:1490783621;s:59:"E:\workspace-php\l7cms\templates\default\common\footer.html";i:1487844022;}*/ ?>
<!DOCTYPE html><html lang="zh-CN"><head>
...
<!-- <script type="text/javascript">
	...
	<script>        
	function myswiperNewsInfoLsFun() {		var NewsInfoLs = $('#NewsInfoLs');		var sweiperpage =  NewsInfoLs.find('.swiper-slide');		var mySwiper = null;		console.log(sweiperpage.length);		if (sweiperpage.length <=1) {			$('.swiper-button-prev').hide();			$('.swiper-button-next').hide(); 		}else{		 mySwiper = new Swiper ('#NewsInfoLs', {			loop: true,		    // 如果需要前进后退按钮		    nextButton: '.swiper-button-next',		    prevButton: '.swiper-button-prev',		    			})    			$('.swiper-button-prev').click(function(){				mySwiper.swipePrev(); 			})			$('.swiper-button-next').click(function(){				mySwiper.swipeNext(); 			}) 		}	}	myswiperNewsInfoLsFun();
  </script>