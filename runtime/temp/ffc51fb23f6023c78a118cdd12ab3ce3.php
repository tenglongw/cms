<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:64:"E:\workspace-php\l7cms\templates\default\content\video_list.html";i:1487844660;s:57:"E:\workspace-php\l7cms\templates\default\common\head.html";i:1488795468;s:59:"E:\workspace-php\l7cms\templates\default\common\header.html";i:1489038618;s:68:"E:\workspace-php\l7cms\templates\default\common\video_selection.html";i:1484107423;s:59:"E:\workspace-php\l7cms\templates\default\common\footer.html";i:1487844022;}*/ ?>
<!DOCTYPE html><html lang="zh-CN"><head>
 ...
 -->
	...
	<section class="VideoList">
		<div class="centerCon ">			<!-- 精选视频 -->
			<?php $data = [];$_where = [];$_where['mark'] = ['eq','shipin_selection'];$_where['status'] = ['eq',1];if($_cate = \app\admin\model\Recommendcate::where($_where) -> find()){ $data = $_cate -> recommend()  -> order('sort desc,id desc') -> limit('5') -> where('status',1) -> select(); } ?><div class="listOne">
	<div class="IdheadTow">视频精选</div>
	<ul class="onlist clearfloat">        			<?php if(is_array($data) || $data instanceof \think\Collection): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$vo): ?>        				<li>							<a href="<?php echo $vo['url']; ?>">											<div class="imgC"><img src="<?php echo thumb($vo['thumb'],470,355); ?>"></div>											<div class="fud">												<p><?php echo $vo['title']; ?> </p>											</div>										</a>						</li>     			<?php endforeach; endif; else: echo "" ;endif; ?>
			...
			<div class="listTwo">
				...
				<ul id="wolist" class="wolist clearfloat">
				</ul>				<div class="IndMore" >					<a href="more" style="display: none" id="more" data-id='<?php echo $category['id']; ?>'>Load more</a>				</div>
			</div>
		</div>
	</section><script type="text/javascript">
    function addDoem(data){        var html = '';        for (var i = 0; i < data.length; i++) {            html+= '<li><a href="'+data[i].url+'"><div class="imgC"><img src="'+data[i].thumb+'"></div><div class="fud"><p>'+data[i].title+'</p></div></a></li>'        }        $('#wolist').append(html);    }
</script>	<!-- footer --><footer id="footer">
	<div class="centerCon">
